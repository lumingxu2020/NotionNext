...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.moming.chat/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, MIDJOURNEY, 人工智能, AI绘画, chatgpt, Notion, 博客', // 网站关键词 英文逗号隔开
